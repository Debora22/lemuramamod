...
describe('Factory: TaggingHelperFactory', function() {
    var $rootScope;
    var TaggingHelperFactory;
    var authService;
    var adminAPIService;
    var $q;
    ...
    beforeEach(inject(function(
        ...
        TaggingHelperFactory = _TaggingHelperFactory_;
    ...
    beforeEach(inject(function($httpBackend) {
        ...
        TaggingHelperFactory.resetCustomer();
    }));

    describe('Actions tracking', function() {
        it('should provide tracking object', function() {
            expect(TaggingHelperFactory.trackAssing).toEqual(jasmine.any(Function));
        });
        ...
        it('should track an approve action', function() {
            ...
            // Set filters values
            TaggingHelperFactory.setFiltersValue({
                query: {
                    filters: { }
                }
            });
            ...
            //When
            TaggingHelperFactory.approveMediaBatch([entity]);
            ...
            expect($rootScope.$emit).not.toHaveBeenCalledWith(INTERNAL_TRACKING_EVENTS.media.tagged, 1);
        ...
        it('should track approved and tagged actions when streams are presented', function() {
            ...
            expect(trackingService.flush).toHaveBeenCalled();
            expect($rootScope.$emit).toHaveBeenCalledWith(INTERNAL_TRACKING_EVENTS.media.approved, 1);
            expect($rootScope.$emit).toHaveBeenCalledWith(INTERNAL_TRACKING_EVENTS.media.tagged, 1);
            expect(adminAPIService.linkStatusToMedia.calls.count()).toEqual(1);
            expect(adminAPIService.linkStatusToMedia).toHaveBeenCalledWith([entity], API_MEDIA_STATUSES_ID.PENDING);
        });
        ...
        it('should track a reject action', function() {
            ...
            //When
            TaggingHelperFactory.rejectMediaBatch([entity]);
            deferredlinkStatusToMediaResponse.resolve({
                data: {
                    media: {
                        111: {
            ...
            expect(trackingService.flush).toHaveBeenCalled();
            expect(adminAPIService.linkStatusToMedia.calls.count()).toEqual(1);
            expect(adminAPIService.linkStatusToMedia).toHaveBeenCalledWith([entity], API_MEDIA_STATUSES_ID.QA_TAGGING);
        });
        ...
        it('should track a report as spam action', function() {
            ...
            //When
            TaggingHelperFactory.flagMediaAsSpamBatch([entity]);
            deferredlinkStatusToMediaResponse.resolve({
                data: {
                    media: {
                        111: {
        ...
        it('should track a streams assignation', function() {
            ...
            //When
            TaggingHelperFactory.trackAssing([entity], dataToAssing);
            $rootScope.$digest();
        ...
        it('should track a streams assignation with metadata Information when it is defined', function() {
            ...
            //When
            TaggingHelperFactory.trackAssing([entity], dataToAssing, metadataValue);
            $rootScope.$digest();
    ...
    describe('tagging section methods', function() {
        ...
        it('should get annotationsData from adminApiService', function() {
            ...
            //When
            TaggingHelperFactory.getAnnotations(mediaId, streamlist);
